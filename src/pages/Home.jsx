      ...
      <header className="sticky top-0 z-40 w-full border-b bg-background">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <a href="#pharmacy" className="text-sm font-medium transition-colors hover:text-primary">
              Pharmacy
            </a>
            <a href="#supermarket" className="text-sm font-medium transition-colors hover:text-primary">
              Supermarket
            </a>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a href="#pharmacy" className="text-gray-500 hover:text-primary">
                    Pharmacy Services
                  </a>
                </li>
                <li>
                  <a href="#supermarket" className="text-gray-500 hover:text-primary">
                    Supermarket
                  </a>
                </li>
                <li>
